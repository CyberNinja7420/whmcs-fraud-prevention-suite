{literal}
<style>
.fps-global{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1a1a2e;line-height:1.7;max-width:1200px;margin:0 auto;}
...
.fps-global-nav a{padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:600;font-size:0.9rem;border:1px solid #e0e0e0;color:#667eea;background:#fff;transition:all 0.2s;}
...
.fps-g-card{background:#fff;border-radius:12px;padding:24px;text-align:center;box-shadow:0 4px 16px rgba(0,0,0,0.08);border:1px solid #e8ecf4;}
.fps-g-card .val{font-size:2rem;font-weight:800;display:block;}
.fps-g-card .lbl{font-size:0.85rem;color:#666;text-transform:uppercase;letter-spacing:0.5px;}
...
.fps-g-section{background:#fff;border-radius:12px;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,0.06);border:1px solid #e8ecf4;margin-bottom:24px;}
.fps-g-section h2{font-size:1.4rem;font-weight:700;margin:0 0 16px;display:flex;align-items:center;gap:10px;color:#1a1a2e;}
...
.fps-g-bar .bar{flex:1;height:24px;background:#f0f0f5;border-radius:4px;overflow:hidden;}
.fps-g-bar .bar .fill{height:100%;border-radius:4px;transition:width 0.5s;}
.fps-g-bar .count{width:60px;text-align:right;font-size:0.85rem;font-weight:700;color:#444;}
.fps-g-table{width:100%;border-collapse:collapse;}
.fps-g-table th{background:#f8f9fc;padding:10px 14px;text-align:left;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.5px;color:#888;border-bottom:2px solid #e8ecf4;}
.fps-g-table td{padding:10px 14px;border-bottom:1px solid #f0f0f5;font-size:0.9rem;}
...
<div class="fps-global">
    ...
    <div class="fps-g-section">
        ...
        <p style="color:#666;margin:0 0 20px;">Breakdown of detected anonymity tools and obfuscation methods across all scanned IPs.</p>
    ...
    <div class="fps-g-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;">
            <div style="text-align:center;padding:16px;border-radius:10px;background:rgba(56,239,125,0.06);border:1px solid rgba(56,239,125,0.15);">
                ...
                <div style="font-size:0.85rem;color:#666;">Low Risk</div>
            </div>
            <div style="text-align:center;padding:16px;border-radius:10px;background:rgba(245,200,66,0.06);border:1px solid rgba(245,200,66,0.15);">
                ...
                <div style="font-size:0.85rem;color:#666;">Medium Risk</div>
            </div>
            <div style="text-align:center;padding:16px;border-radius:10px;background:rgba(245,87,108,0.06);border:1px solid rgba(245,87,108,0.15);">
                ...
                <div style="font-size:0.85rem;color:#666;">High Risk</div>
            </div>
            <div style="text-align:center;padding:16px;border-radius:10px;background:rgba(235,51,73,0.06);border:1px solid rgba(235,51,73,0.15);">
                ...
                <div style="font-size:0.85rem;color:#666;">Critical Risk</div>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;align-items:center;gap:8px;">
                            ...
                            <span style="font-size:0.8rem;color:#888;">{math equation="round(x/y*100,1)" x=$cnt y=$stats.total_checks}%</span>
                        </div>
                    </td>
                </tr>
            {/foreach}
    ...
    <div class="fps-g-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;">
            <div style="padding:20px;border-radius:10px;background:rgba(102,126,234,0.04);border:1px solid rgba(102,126,234,0.12);">
                ...
                <p style="margin:0;font-size:0.9rem;color:#555;">Each WHMCS instance running FPS collects fraud signals locally: email hashes, IPs, risk scores, and boolean evidence flags.</p>
            </div>
            <div style="padding:20px;border-radius:10px;background:rgba(102,126,234,0.04);border:1px solid rgba(102,126,234,0.12);">
                <h3 style="margin:0 0 8px;font-size:1rem;"><i class="fas fa-cloud-arrow-up" style="color:#667eea;"></i> 2. Anonymized Sharing</h3>
                <p style="margin:0;font-size:0.9rem;color:#555;">Data is anonymized (SHA-256 email hashes) and pushed to the central hub. Raw emails, names, and billing data never leave your instance.</p>
            </div>
            <div style="padding:20px;border-radius:10px;background:rgba(102,126,234,0.04);border:1px solid rgba(102,126,234,0.12);">
                <h3 style="margin:0 0 8px;font-size:1rem;"><i class="fas fa-shield-halved" style="color:#667eea;"></i> 3. Cross-Reference</h3>
                <p style="margin:0;font-size:0.9rem;color:#555;">When new clients sign up, their email and IP are checked against the global database. Known fraudsters are flagged across all instances.</p>
            </div>
            <div style="padding:20px;border-radius:10px;background:rgba(102,126,234,0.04);border:1px solid rgba(102,126,234,0.12);">
                <h3 style="margin:0 0 8px;font-size:1rem;"><i class="fas fa-gavel" style="color:#667eea;"></i> 4. GDPR Compliant</h3>
                <p style="margin:0;font-size:0.9rem;color:#555;">Opt-in only. Full right to erasure (Art. 17). Data export (Art. 20). Configurable retention. IP sharing is optional and toggleable.</p>
            </div>
        </div>
    </div>

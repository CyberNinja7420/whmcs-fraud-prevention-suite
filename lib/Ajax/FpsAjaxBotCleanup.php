...
// fps_ajaxGetModuleLog() lives in the main module file (fraud_prevention_suite.php)
// to avoid "Cannot redeclare" collisions. This comment replaces the dangling
// docblock that was here before the audit fix.
